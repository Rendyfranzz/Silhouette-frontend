...
const About = () => {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center font-popin'>
      ...
      <div className='w-screen h-48 bg-black p-2'>
        <h1 className='text-title text-white text-center font-bold'>WHY BOOK WITH US?</h1>
      ...
      <div className='w-screen h-48 flex flex-row justify-evenly items-center'>
        <h1 className='text-title text-black text-center font-bold'>Jam Operasional</h1>
        <div className='flex flex-row justify-center items-center space-x-6'>
          <table className='border-separate border-spacing-2 border-spacing-x-8 text-title'>
            <tr>
              <td>Sabtu-Rabu</td>
              <td>10.00-20.00</td>
            </tr>
